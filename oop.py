...
class Student:
    ...
    def __str__(self):
        res = f'Имя: {self.name}\nФамилия: {self.surname}\nСредний балл за домашние задания: {self.av_rating()}\nКурсы в процессе изучения: {", ".join(self.courses_in_progress)}\nЗавершенные курсы: {", ".join(self.finished_courses)}'
        return res
...
class Lecturer(Mentor):
    ...
    def __str__(self):
        res = f"Имя: {self.name}\nФамилия: {self.surname}\nСредний балл за лекции: {self.av_rating()}"
        return res
...
# Студенты
student_1 = Student('Маша', 'Ивова', 'Жен')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ["Git"]

student_2 = Student('Серьгей', 'Жуков', 'Муж')
student_2.courses_in_progress += ['Python']
student_2.finished_courses += ["Git"]

# Лекторы
lecturer_1 = Lecturer('Викторг', 'Павлович')
lecturer_1.courses_attached += ['Python']
 
lecturer_2 = Lecturer('Марина', 'Птичкина')
lecturer_2.courses_attached += ['Python']

# Проверяющие
reviewer_1 = Reviewer('Петр', 'Угрюмов')
reviewer_1.courses_attached += ['Python']
 
reviewer_2 = Reviewer('Василиса', 'Сергевна')
...
student_2.rate_lw(lecturer_2, 'Python', 4)
...
print(f"Средний балл студентов: {average_rating_for_course('Python', student_list)}")
print(f"Средний балл лекторов: {average_rating_for_course('Python', lecturer_list)}", "\n")
print(student_1,"\n")
print(student_2,"\n")
print(lecturer_1,"\n")
print(lecturer_2,"\n")